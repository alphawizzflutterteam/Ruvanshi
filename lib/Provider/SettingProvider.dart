...
class SettingProvider {
  ...
  String get cityId => _sharedPreferences.getString(CITY_ID) ?? "";
  String get city => _sharedPreferences.getString(CITY) ?? "";
  ...
  void setCity(String key, String value) async {
    _sharedPreferences.setString(key, value);
  }
  ...
  Future<void> clearUserSession(BuildContext context) async {
    ...
    userProvider.setCityID("");
    userProvider.setCity("");
  ...
  Future<void> saveUserDetail(
    ...
    waitList.add(_sharedPreferences.setString(CITY_ID, cityId ?? ""));
    ...
    userProvider.setCityID(cityId ?? "");
    userProvider.setCity(city ?? '');
