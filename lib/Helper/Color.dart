...
extension colors on ColorScheme {
  ...
  static const Color secondary = Color(0xffD7AF33);
  static const Color text = Color(0xffD7AF33);
  ...
  Color get gray =>
      this.brightness == Brightness.dark ? darkColor3 : Color(0xFFD7AF33);
  ...
  static const Color red = Color(0xFFFC8617);
