...
import 'package:TGSawadesiMartUser/Screen/Customer_Support.dart';
import 'package:TGSawadesiMartUser/Screen/MyTransactions.dart';
import 'package:TGSawadesiMartUser/Screen/ReferEarn.dart';
...
/*  _getDivider() {
  ...
  Widget savelabelLarge(String title, VoidCallback? onBtnSelected) {
    return Row(
      children: [
        Expanded(
          child: Padding(
          ...
          return StatefulBuilder(
            ...
            return Wrap(
              children: [
                Padding(
                  padding: EdgeInsets.only(
                      bottom: MediaQuery.of(buildContexts).viewInsets.bottom),
                  child: Form(
                    key: _changePwdKey,
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        ...
                        setCurrentPasswordField(setStates: setState),
                        setForgotPwdLable(),
                        newPwdField(setStates: setState),
                        confirmPwdField(setStates: setState),
                        savelabelLarge(
                            getTranslated(buildContexts, "SAVE_LBL")!, () {
  ...
  Widget setCurrentPasswordField({required StateSetter setStates}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 15.0),
      child: Container(
        decoration: BoxDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () {
                  setStates(() {
                    ...
                    // This will trigger a rebuild to update the icon
                  });
                },
              ),
            ),
  ...
  Widget newPwdField({required StateSetter setStates}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 15.0),
      child: Container(
        decoration: BoxDecoration(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            validator: (val) => validatePass(
              val!,
              getTranslated(context, 'PWD_REQUIRED') ?? "Required",
              getTranslated(context, 'PWD_LENGTH') ?? "Too short",
            ),
          ),
        ),
      ),
  ...
  Widget confirmPwdField({required StateSetter setStates}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 15.0),
      child: Container(
        decoration: BoxDecoration(
